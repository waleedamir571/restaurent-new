...
<div class="wrapper">
    ...
    <section class="section kf-started-inner">
        <div class="kf-parallax-bg js-parallax" style="background-image: url(images/about/about.png);"></div>
        <div class="container">
    ...
    <!-- <section class="section kf-video">
        <div class="container-fluid">
            ...
            <div class="kf-video-item kf-image-hover element-anim-1 scroll-animate"
                style="background-image: url(images/about/Sectionvideo.png);" data-animate="active">
    ...
    <div class="section kf-video kf-video-full">
        <div class="kf-video-item kf-parallax" style="background-image: url(images/about/Sectionvideo.png);">
    ...
    <section class="section  section-bg">
        <div class="container-fluid">
            ...
            <div class="kf-titles align-center">
                <div class="kf-subtitle element-anim-1 scroll-animate" data-animate="active">
                    Choose Best of dolly’s SISTER LOCATIONS
                </div>
                <h3 class="kf-title element-anim-1 scroll-animate" data-animate="active">
                    OUR SISTER BARS
                </h3>
            ...
            <div class="container-fluid section kf-brands">
                <div class="kf-team-items">
                    <div class="team-item">
                        <img src="images/about/l1.png" alt="">
                    </div>
                    <div class="team-item">
                        <img src="images/about/l2.png" alt="">
                    </div>
                    <div class="team-item">
                        <a href="https://www.dollyvardennyc.com/"> <img src="images/about/l3.png" alt=""> </a>
                    </div>
                    <div class="team-item">
                        <img src="images/about/l4.png" alt="">
                    </div>
                    <div class="team-item">
                        <img src="images/about/l5.png" alt="">
                    </div>
                </div>
            </div>
