...
<div class="wrapper">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-5">
					...
					<div class="kf-text element-anim-1 scroll-animate" data-animate="active">
						<p>
							Dolly’s Hideaway is a cozy bar tucked away below the Dolly Varden Restaurant here we
							offer friends a refuge from the bustling city outside. The cocktails are often
							thoughtfully crafted, leaning on classic recipes with unique twists and many of our
							food offerings are designed to share. It’s the kind of place where you can escape
							the crowds of nearby Times Square and the Theatre District and enjoy a more
							personal, relaxed evening with friends or on a date. Do you like discovering hidden
							spots like this?
						</p>
					</div>
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
					<div class="kf-services-item element-anim-1 scroll-animate" data-animate="active">
						<div class="image kf-image-hover">
							<a href="#"><img src="images/home/r2.png" alt="" /></a>
						</div>
						<div class="desc">
	...
	<div class="section kf-video kf-video-full">
		<div class="kf-video-item kf-parallax" style="background-image: url(images/home/video-sec.png);">
			<iframe class="js-video-iframe" src="https://www.youtube.com/embed/7iIa8RGbwG4?rel=0&autoplay=0"
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
					...
					<div class="kf-choose-image element-anim-1 scroll-animate" data-animate="active">
						<img src="images/home/choose_img.jpg.png" alt="" />
					</div>
				...
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						...
						<div class="slide-item element-anim-1 scroll-animate" data-animate="active">
							<div class="image kf-image-hover">
								<a href="images/home/slide1.png" class="has-popup-image"><img
										src="images/home/slide1.png" alt="" /></a>
							</div>
							<div class="desc">
					...
					<div class="swiper-slide">
						...
						<div class="slide-item element-anim-1 scroll-animate" data-animate="active">
							<div class="image kf-image-hover">
								<a href="images/home/slide2.png" class="has-popup-image"><img
										src="images/home/slide2.png" alt="" /></a>
							</div>
							<div class="desc">
					...
					<div class="swiper-slide">
						...
						<div class="slide-item element-anim-1 scroll-animate" data-animate="active">
							<div class="image kf-image-hover">
								<a href="images/home/slide3.png" class="has-popup-image"><img
										src="images/home/slide3.png" alt="" /></a>
							</div>
							<div class="desc">
						...
						<div class="swiper-slide">
							...
							<div class="slide-item element-anim-1 scroll-animate" data-animate="active">
								...
								<div class="desc">
									...
									<div class="text">
										Dolly's Hideaway on the lower level of Dolly Varden is a luscious
										speakeasy with heavenly bar food and out of this world cocktails in an
										exceptionally cozy and attentive environment - not to be missed! We
										stumbled upon this gem before our Broadway show and was so enamored with
										the food, drinks and service that we returned post-show for an encore!
									</div>
									<h5 class="name">Melissa P. <em>Dublin CA</em></h5>
								</div>
							</div>
						...
						<div class="swiper-slide">
							...
							<div class="slide-item element-anim-1 scroll-animate" data-animate="active">
								...
								<div class="desc">
									...
									<div class="text">
										Love their cocktail tree! The presentation is absolutely stunning! You
										can select five different cocktails for the tree. We also tried an array
										of delicious dishes. We had mussels, risotto balls, lamb shank,
										buttermilk fried chicken burger, and dessert. Everything is so good.
									</div>
									<h5 class="name">Shirley H. <em>East Side NYC</em></h5>
								</div>
							</div>
						...
						<div class="swiper-slide">
							...
							<div class="slide-item element-anim-1 scroll-animate" data-animate="active">
								...
								<div class="desc">
									...
									<div class="kf-text">
										Delicious brunch! Walked by with my husband on New Year's Eve, and super
										glad we picked this spot. Great Bloody Mary, prickly non alcoholic drink
										was delicious. Steak and eggs were fantastic, we also got really good
										deviled eggs. Hostess in the front and our waiter Cesar were both great.
									</div>
									<h5 class="name">Alexandra A. <em>Hialeah, FL</em></h5>
								</div>
							</div>
						...
						<div class="swiper-slide">
							...
							<div class="slide-item element-anim-1 scroll-animate" data-animate="active">
								...
								<div class="desc">
									...
									<h5 class="name">Bella S. <em>Bronx NY</em></h5>
								</div>
							</div>
			...
			<div class="kf-blog-grid-items row">
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
					<div class="kf-blog-grid-item element-anim-1 scroll-animate" data-animate="active">
						<div class="image kf-image-hover">
							<a href="#"><img src="images/home/c3 (2).png" alt="" /></a>
						</div>
						<div class="desc">
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
					<div class="kf-blog-grid-item element-anim-1 scroll-animate" data-animate="active">
						<div class="image kf-image-hover">
							<a href="#"><img src="images/home/c3 (1).png" alt="" /></a>
						</div>
						<div class="desc">
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
					<div class="kf-blog-grid-item element-anim-1 scroll-animate" data-animate="active">
						<div class="image kf-image-hover">
							<a href="#"><img src="images/home/c3 (3).png" alt="" /></a>
						</div>
						<div class="desc">
							<h5 class="name">SWR React Hooks With Next Increm Ental Static Regeneration</h5>
							<div class="kf-date"><i class="far fa-calendar-alt"></i>25 Sep 2021</div>
